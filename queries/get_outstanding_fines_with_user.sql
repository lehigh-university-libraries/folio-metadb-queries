--metadb:function get_outstanding_fines_with_user
-- This function retrieves all outstanding fines for a given user.
CREATE FUNCTION get_outstanding_fines_with_user()
